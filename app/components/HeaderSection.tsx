  ...
  return (
    <header className="w-full bg-white dark:bg-[#0A0A0A] transition-colors duration-300 font-sans border-b border-gray-100 dark:border-gray-800 relative z-50 sticky top-0">
      ...
      <div className="hidden md:block">
        {/* 1. TOP BAR (Date & Links) - HIDDEN */}
        <div className="hidden">
          <div className="container mx-auto px-4 flex justify-between items-center">
            <span className="opacity-90 tracking-wide font-medium">
              {dateStr}
            </span>
            <div className="flex gap-4">
              <a href="#" className="hover:text-[#D91B1B] transition-colors">Tentang Kami</a>  
              <a href="#" className="hover:text-[#D91B1B] transition-colors">Redaksi</a>
              <a href="#" className="hover:text-[#D91B1B] transition-colors">Pedoman Media Siber</a>
            </div>
          </div>
        </div>

        {/* 2. MAIN HEADER (Logo, Search, Tools) */}
        <div className="container mx-auto px-4 py-4 md:py-6 flex items-center justify-between relative">
          
          {/* LEFT: Mobile Menu & TV Badge */}
          ...
          <div className="w-auto md:w-1/3 flex justify-center absolute left-1/2 transform -translate-x-1/2">
            <a href="/" className="block group">
              {/* Menggunakan img tag biasa agar aman di preview environment */}
              <img 
                src={theme === 'light' ? (LogoLight.src || LogoLight) : (LogoDark.src || LogoDark)}
                alt="SIN PO Logo" 
